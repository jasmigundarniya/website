        ...
        <PrimaryLayout>
            <div className='bg-[#f3f6fe]  h-[calc(100vh-82.4px)] overflow-auto'>
                <div className="container px-40 3xl:px-20 xl:px-5">
                    ...
                    <div className="heading font-normal text-[26px] xs:text-[20px] pb-[20px] flex gap-1">
                        ...
                        <div className='flex justify-center'>
                            <div className='flex flex-col gap-3 bg-white xs:p-5 p-10 rounded-lg border border-[#D6D7DC] w-[593px]'>
                                <div className='relative'>
                                    <div onClick={() => setPricingOpen(true)} className='cursor-pointer'>
                                    ...
                                    <ProductModal isOpen={pricingOpen} onClose={() => setPricingOpen(false)} />
                                </div>

                                <div className='relative'>
                                    <div onClick={() => setCountryOpen(true)} className='cursor-pointer'>
                                    ...
                                    <CountryModal isOpen={countryOpen} onClose={() => setCountryOpen(false)} />
                                </div>
                                <div className='relative'>
                                    <div>
