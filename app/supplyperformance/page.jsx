...
export default function SupplyPerformance() {
  ...
  const accordionData = Array.from({ length: 10 }, (_, index) => ({
    heading: (
      <div
        className={`py-2.5 px-10 flex items-center justify-between ${openIndex === index ? "bg-[#F3F6FE]" : ""
    ...
    content: (
      <div className={`border-b border-[#0000001A] w-full`}>
        <div className="bg-[#B2B2B2] w-full px-10 py-3 text-[16px]">Active</div>
    ...
    <PrimaryLayout>
      <div className="px-40 3xl:px-20 xl:px-5 bg-[#F3F6FE]">
        ...
        <div className="overflow-x-auto">
          ...
          <div className="mt-5 bg-white rounded-lg border border-[#D6D7DC] min-w-[900px]">
            <div className="py-4 px-10 flex items-center justify-between border-b border-[#0000001A]">
              <div className="uppercase text-black text-sm font-bold w-full md:flex-shrink-0 md:w-2/12 text-[16px]">
                In charge
              </div>
              <div className="uppercase text-black text-sm font-bold w-full md:flex-shrink-0 md:w-2/12 text-center text-[16px]">
                Active
              </div>
              <div className="uppercase text-black text-sm font-bold w-full md:flex-shrink-0 md:w-2/12 text-center text-[16px]">
                Expired
              ...
              <div className="uppercase text-black text-sm font-bold w-full md:flex-shrink-0 md:w-2/12 text-end text-[16px]">
                Total
              </div>
