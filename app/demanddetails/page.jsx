    ...
    content: (
      <div className={`px-10 md:px-2 border-b border-[#0000001A] w-full`}>
        <div className="flex items-center justify-between w-full border-b border-[#1F263E36] border-dashed py-3">
          <div className="gap-3 text-black text-sm md:text-[10px] font-medium w-full text-[16px] italic">
            Cup Stock, Turkey
          </div>
        ...
        <div className="flex items-center justify-between w-full border-b border-[#1F263E36] border-dashed py-3">
          <div className="flex gap-3 text-black text-sm md:text-[10px] font-medium w-full text-[16px] italic">
            Cup Stock, Turkey
          </div>
          <div className="w-full"></div>
          <div className="text-black text-sm md:text-[10px] font-medium w-full text-center text-[16px]">
