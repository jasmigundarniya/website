...
export default function SupplyPerformance() {
  ...
  const accordionData = Array.from({ length: 10 }, (_, index) => ({
    heading: (
      <div
        className={`py-2.5 px-10 flex items-center justify-between ${openIndex === index ? "" : ""
        ...
        <div className="overflow-x-auto">
          <div className="mt-5 bg-white rounded-lg border border-[#D6D7DC] min-w-[900px]">
            <div className="py-4 px-10 flex items-center justify-between border-b border-[#0000001A]">
              <div className="uppercase text-black text-sm font-bold w-full md:flex-shrink-0 md:w-2/12 text-[16px] flex items-center gap-2">
                In charge <Sort />
              </div>
